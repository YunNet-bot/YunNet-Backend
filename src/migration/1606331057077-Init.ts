...
export class Init1606331057077 implements MigrationInterface {
  ...
  private async createKeyAndIndices(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.createForeignKeys('announcement', [
      new TableForeignKey({
        name: 'announcement_fk_user', columnNames: ['uid'], referencedTableName: 'user', referencedColumnNames: ['uid'],
      }),
    ]);
    // BackupMac
    ...
    await queryRunner.createForeignKeys('backup_mac', [
      new TableForeignKey({
        name: 'backup_mac_fk_iptable', columnNames: ['ip'], referencedTableName: 'iptable', referencedColumnNames: ['ip'],
      }),
    ]);
    // Bed: no need.
    // Group: no need.
    ...
    await queryRunner.createForeignKeys('group_inherit', [
      new TableForeignKey({
        name: 'group_inherit_fk_group', columnNames: ['gid'], referencedTableName: 'group', referencedColumnNames: ['gid'],
      }),
      new TableForeignKey({
        name: 'group_inherit_fk_group_p', columnNames: ['parent_gid'], referencedTableName: 'group', referencedColumnNames: ['gid'],
      }),
    ]);
    // GroupManagedBy
    ...
    await queryRunner.createForeignKeys('group_managed_by', [
      new TableForeignKey({
        name: 'fk_gid_managed_by_gid', columnNames: ['gid'], referencedTableName: 'group', referencedColumnNames: ['gid'],
      }),
      new TableForeignKey({
        name: 'fk_gid_managed_by_parent_gid', columnNames: ['parent_gid'], referencedTableName: 'group', referencedColumnNames: ['gid'],
      }),
    ]);
    // GroupPermission
    ...
    await queryRunner.createForeignKeys('group_permission', [
      new TableForeignKey({
        name: 'group_permission_fk_group', columnNames: ['gid'], referencedTableName: 'group', referencedColumnNames: ['gid'],
      }),
      new TableForeignKey({
        name: 'group_permission_fk_permission', columnNames: ['pid'], referencedTableName: 'permission', referencedColumnNames: ['pid'],
      }),
    ]);
    // GroupUser
    ...
    await queryRunner.createForeignKeys('group_user', [
      new TableForeignKey({
        name: 'group_user_fk_group', columnNames: ['gid'], referencedTableName: 'group', referencedColumnNames: ['gid'],
      }),
      new TableForeignKey({
        name: 'group_user_fk_user', columnNames: ['uid'], referencedTableName: 'user', referencedColumnNames: ['uid'],
      }),
    ]);
    // Iptable
    ...
    await queryRunner.createForeignKeys('iptable', [
      new TableForeignKey({
        name: 'iptable_fk_group', columnNames: ['gid'], referencedTableName: 'group', referencedColumnNames: ['gid'],
      }),
      new TableForeignKey({
        name: 'iptable_fk_ip_type', columnNames: ['ip_type_id'], referencedTableName: 'ip_type', referencedColumnNames: ['ip_type_id'],
      }),
      new TableForeignKey({
        name: 'iptable_fk_switch', columnNames: ['switch_id'], referencedTableName: 'switch', referencedColumnNames: ['id'],
      }),
      new TableForeignKey({
        name: 'iptable_fk_user', columnNames: ['uid'], referencedTableName: 'user', referencedColumnNames: ['uid'],
      }),
    ]);
    // IptableTest
    ...
    await queryRunner.createForeignKeys('lock', [
      new TableForeignKey({
        name: 'lock_fk_lock_type', columnNames: ['lock_type_id'], referencedTableName: 'lock_type', referencedColumnNames: ['lock_type_id'],
      }),
      new TableForeignKey({
        name: 'lock_fk_user', columnNames: ['lock_by_user_id'], referencedTableName: 'user', referencedColumnNames: ['uid'],
      }),
    ]);
    // LockType: no need.
    // Netflow: no need.
    ...
    await queryRunner.createForeignKeys('switch', [
      new TableForeignKey({
        name: 'switch_fk_self_upper_id', columnNames: ['upper_switch'], referencedTableName: 'switch', referencedColumnNames: ['id'],
      }),
    ]);
    // Token
    await queryRunner.createForeignKeys('token', [
      new TableForeignKey({
        name: 'token_fk_user', columnNames: ['uid'], referencedTableName: 'user', referencedColumnNames: ['uid'],
      }),
    ]);
    // User
    ...
    await queryRunner.createForeignKeys('user_permission', [
      new TableForeignKey({
        name: 'user_permission_fk_permission', columnNames: ['pid'], referencedTableName: 'permission', referencedColumnNames: ['pid'],
      }),
      new TableForeignKey({
        name: 'user_permission_fk_user', columnNames: ['uid'], referencedTableName: 'user', referencedColumnNames: ['uid'],
      }),
    ]);
    // Variable: no need.
  }
